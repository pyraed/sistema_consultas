...
def calcular_membresia(entidad: str, reparticion: str, monto: float) -> tuple:
    ...
    if ent == "aamas":
        ...
        return 9_594, 9_850, 9_700, 6_000
    return 0, 0, 0, 0
...
def _texto_contrato(c, i: int, rep: str, entidad: str, datos: dict, cuota_prestamo: float):
    ...
    if ent == "aamas":
        ...
        if i == 0:
            ...
            c.drawString(470, 665, f"La Plata, {datos['fecha_firma']}")
...
def calcular():
    ...
    if request.form.get("alt", "0") == "1":
        valor_cuota = 22_073 if reparticion.lower() == "policia" else 22_176
    ...
    valor_cuota_alt = 22_073 if reparticion.lower() == "policia" else 22_176
